  ...
  try {
    ...
    if (pErr || !project) {
      ...
      const { data: stakeholders } = await supabase
        ...
        .select(
          "*, csc_assessments!csc_stakeholders_assessment_id_fkey(share_id, status, overall_score, maturity_stage)"
        )
    ...
    const { data: stakeholders } = await supabase
      .from("csc_stakeholders")
      .select("*, csc_assessments(share_id, status, overall_score, maturity_stage)")
    ...
    console.error("GET /api/csc/projects/[id] error:", err);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/csc/projects/[id] error:", err);
    return NextResponse.json(
...
/**
 * DELETE /api/csc/projects/:id?mode=orphan|cascade
 *
 * orphan (default): delete the project; csc_assessments.project_id sets
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/csc/projects/[id] error:", err);
    return NextResponse.json(
