...
export async function POST(
  ...
  try {
    ...
    console.error("POST /api/csc/projects/[id]/stakeholders error:", err);
    return NextResponse.json(
...
export async function GET(
  ...
  try {
    ...
    const { data, error } = await supabase
      .from("csc_stakeholders")
      .select(
        "*, csc_assessments!csc_stakeholders_assessment_id_fkey(status, overall_score, maturity_stage, updated_at)"
      )
    ...
    console.error("GET /api/csc/projects/[id]/stakeholders error:", err);
    return NextResponse.json(
