...
export async function GET(
  ...
  try {
    ...
    console.error("GET /api/aient/assessments/[id] error:", err);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/aient/assessments/[id] error:", err);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/aient/assessments/[id] error:", err);
    return NextResponse.json(
      { error: "Failed to delete AI for Enterprise assessment" },
      { status: 500 }
    );
  }
}
