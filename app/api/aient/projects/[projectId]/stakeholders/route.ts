...
export async function POST(
  ...
  try {
    ...
    console.error("POST /api/aient/projects/[id]/stakeholders error:", err);
    return NextResponse.json(
...
export async function GET(
  ...
  try {
    ...
    const { data, error } = await supabase
      .from("aient_stakeholders")
      .select(
        "*, aient_assessments!aient_stakeholders_assessment_id_fkey(status, overall_score, maturity_stage, updated_at)"
      )
    ...
    console.error("GET /api/aient/projects/[id]/stakeholders error:", err);
    return NextResponse.json(
