  ...
  try {
    ...
    if (pErr || !project) {
      ...
      const { data: stakeholders } = await supabase
        ...
        .select(
          "*, aient_assessments!aient_stakeholders_assessment_id_fkey(share_id, status, overall_score, maturity_stage)"
        )
    ...
    const { data: stakeholders } = await supabase
      .from("aient_stakeholders")
      .select("*, aient_assessments(share_id, status, overall_score, maturity_stage)")
    ...
    console.error("GET /api/aient/projects/[id] error:", err);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/aient/projects/[id] error:", err);
    return NextResponse.json(
...
/**
 * DELETE /api/aient/projects/:id?mode=orphan|cascade
 *
 * orphan (default): delete the project; aient_assessments.project_id sets
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/aient/projects/[id] error:", err);
    return NextResponse.json(
