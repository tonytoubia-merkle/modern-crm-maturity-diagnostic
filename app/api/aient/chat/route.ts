...
import { buildAientSystemPrompt } from "@/lib/aient/chat/buildSystemPrompt";
import type {
  AientInferredScore,
  AientChatPhase,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const {
      ...
      currentScores: Record<string, AientInferredScore>;
    ...
    const systemPrompt = buildAientSystemPrompt(
      clientName,
      respondentName,
      industry,
      currentScores,
    ...
    console.error("POST /api/aient/chat error:", message, err);
    return new Response(
