...
export async function POST(
  ...
  try {
    ...
    console.error("POST /api/aicx/projects/[id]/stakeholders error:", err);
    return NextResponse.json(
...
export async function GET(
  ...
  try {
    ...
    const { data, error } = await supabase
      .from("aicx_stakeholders")
      .select(
        "*, aicx_assessments!aicx_stakeholders_assessment_id_fkey(status, overall_score, maturity_stage, updated_at)"
      )
    ...
    console.error("GET /api/aicx/projects/[id]/stakeholders error:", err);
    return NextResponse.json(
