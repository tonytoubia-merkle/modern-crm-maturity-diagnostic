...
import { buildB2bSystemPrompt } from "@/lib/b2b/chat/buildSystemPrompt";
import type {
  B2bInferredScore,
  B2bChatPhase,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const {
      ...
      currentScores: Record<string, B2bInferredScore>;
    ...
    const systemPrompt = buildB2bSystemPrompt(
      clientName,
      respondentName,
      industry,
      currentScores,
    ...
    console.error("POST /api/b2b/chat error:", message, err);
    return new Response(
