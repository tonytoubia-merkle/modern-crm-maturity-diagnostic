...
export async function GET(
  ...
  try {
    ...
    console.error("GET /api/b2b/assessments/[id] error:", err);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/b2b/assessments/[id] error:", err);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/b2b/assessments/[id] error:", err);
    return NextResponse.json(
      { error: "Failed to delete B2B assessment" },
      { status: 500 }
    );
  }
}
