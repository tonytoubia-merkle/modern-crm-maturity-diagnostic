  ...
  try {
    ...
    if (pErr || !project) {
      ...
      const { data: stakeholders } = await supabase
        ...
        .select(
          "*, b2b_assessments!b2b_stakeholders_assessment_id_fkey(share_id, status, overall_score, maturity_stage)"
        )
    ...
    const { data: stakeholders } = await supabase
      .from("b2b_stakeholders")
      .select("*, b2b_assessments(share_id, status, overall_score, maturity_stage)")
    ...
    console.error("GET /api/b2b/projects/[id] error:", err);
    return NextResponse.json(
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/b2b/projects/[id] error:", err);
    return NextResponse.json(
...
/**
 * DELETE /api/b2b/projects/:id?mode=orphan|cascade
 *
 * orphan (default): delete the project; b2b_assessments.project_id sets
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/b2b/projects/[id] error:", err);
    return NextResponse.json(
