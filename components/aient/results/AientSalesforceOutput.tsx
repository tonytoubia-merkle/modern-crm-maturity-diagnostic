...
import type { AientDiagnosticResults } from "@/lib/aient/types";

interface AientSalesforceOutputProps {
  results: AientDiagnosticResults;
}

function generateNarrative(results: AientDiagnosticResults): string {
  const {
    assessment,
    overallScore,
    maturityStage,
...
function generateOpportunityTable(results: AientDiagnosticResults): string {
...
export function AientSalesforceOutput({ results }: AientSalesforceOutputProps) {
