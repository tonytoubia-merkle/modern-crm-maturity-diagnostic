...
import {
  getAientScoreBarColor,
  getAientScoreBgColor,
  formatAientScore,
} from "@/lib/aient/scoring";
import { AIENT_SCORE_LABELS } from "@/lib/aient/data/questions";
import type { AientCapabilityScore } from "@/lib/aient/types";
...
interface AientCapabilityHeatmapProps {
        ...
        <div className="flex flex-col">
          ...
          <div className="space-y-3">
            {scores.map((s) => {
              ...
              const scoreLabel =
                AIENT_SCORE_LABELS[roundedScore] ??
                AIENT_SCORE_LABELS[Math.ceil(s.score)];
              return (
