...
import {
  ...
  AIENT_CAPABILITY_DESCRIPTIONS,
  AIENT_CAPABILITY_SCOPE_HINTS,
...
interface AientCapabilitySectionProps {
...
export function AientCapabilitySection({
  capability,
  responses,
  onScore,
  onNotes,
    ...
    <div className="space-y-6">
      <div>
        <span className="text-xs font-semibold text-blue-600 uppercase tracking-wider">
          {AIENT_CAPABILITY_SUBTITLES[capability]}
        </span>
        <h2 className="text-2xl font-bold text-slate-900 mt-0.5">
          {AIENT_CAPABILITY_LABELS[capability]}
        </h2>
        <p className="mt-1.5 text-sm text-slate-600 leading-relaxed">
          {AIENT_CAPABILITY_DESCRIPTIONS[capability]}
        </p>
        <p className="mt-2 text-xs text-amber-700 bg-amber-50 border border-amber-100 rounded-lg px-3 py-2 leading-relaxed">
          {AIENT_CAPABILITY_SCOPE_HINTS[capability]}
        </p>
      </div>
