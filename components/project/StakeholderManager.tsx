...
export function StakeholderManager({ projectId, onDone }: StakeholderManagerProps) {
  ...
  const copyLink = (token: string) => {
    const url = `${baseUrl}/survey/${token}`;
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-600 leading-relaxed">
          Add the client stakeholders who will complete the pre-work survey. Each
          person gets a unique link to their own assessment. You&apos;ll be able to
          track completion from the project dashboard.
        </p>
      </div>
