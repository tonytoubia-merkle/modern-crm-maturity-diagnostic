...
import type { AicxInferredScore, AicxChatPhase } from "@/lib/aicx/chat/types";

interface AicxCoverageTrackerProps {
...
const PHASE_LABELS: Record<AicxChatPhase, string> = {
...
export function AicxCoverageTracker({
  scores,
  skipped,
  totalQuestions,
  phase,
  onViewScoreMap,
}: AicxCoverageTrackerProps) {
