...
import type { AicxMaturityStage } from "@/lib/aicx/types";

interface AicxMaturityStageCardProps {
  stage: AicxMaturityStage;
  overallScore: number;
}
...
export function AicxMaturityStageCard({
  stage,
  overallScore,
}: AicxMaturityStageCardProps) {
  const info = AICX_MATURITY_STAGES[stage];
