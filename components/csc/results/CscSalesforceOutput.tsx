...
import type { CscDiagnosticResults } from "@/lib/csc/types";

interface CscSalesforceOutputProps {
  results: CscDiagnosticResults;
}

function generateNarrative(results: CscDiagnosticResults): string {
  const {
    assessment,
    overallScore,
    maturityStage,
...
function generateOpportunityTable(results: CscDiagnosticResults): string {
...
export function CscSalesforceOutput({ results }: CscSalesforceOutputProps) {
