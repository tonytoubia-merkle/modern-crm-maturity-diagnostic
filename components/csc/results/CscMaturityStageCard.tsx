...
import type { CscMaturityStage } from "@/lib/csc/types";

interface CscMaturityStageCardProps {
  stage: CscMaturityStage;
  overallScore: number;
}
...
export function CscMaturityStageCard({
  stage,
  overallScore,
}: CscMaturityStageCardProps) {
  const info = CSC_MATURITY_STAGES[stage];
