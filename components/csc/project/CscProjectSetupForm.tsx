...
interface CscProjectSetupFormProps {
  onSubmit: (data: CscProjectSetupData) => Promise<void>;
}

export function CscProjectSetupForm({ onSubmit }: CscProjectSetupFormProps) {
  const [data, setData] = useState<CscProjectSetupData>({
    clientName: "",
    clientCompany: "",
    industry: "",
    createdByName: "",
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1.5 text-xs text-slate-400">
          ...
          <a href="/csc/assessment/new" className="underline hover:text-slate-600">
            Quick Assessment
          </a>{" "}
          instead.
        </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {(Object.entries(CSC_INDUSTRY_LABELS) as [CscIndustry, string][]).map(
              ([key, label]) => (
                <button
                  key={key}
                  type="button"
