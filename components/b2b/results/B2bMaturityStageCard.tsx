...
import type { B2bMaturityStage } from "@/lib/b2b/types";

interface B2bMaturityStageCardProps {
  stage: B2bMaturityStage;
  overallScore: number;
}
...
export function B2bMaturityStageCard({
  stage,
  overallScore,
}: B2bMaturityStageCardProps) {
  const info = B2B_MATURITY_STAGES[stage];
