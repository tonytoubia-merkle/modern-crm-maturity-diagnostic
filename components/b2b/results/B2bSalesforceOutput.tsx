...
import type { B2bDiagnosticResults } from "@/lib/b2b/types";

interface B2bSalesforceOutputProps {
  results: B2bDiagnosticResults;
}

function generateNarrative(results: B2bDiagnosticResults): string {
  const {
    assessment,
    overallScore,
    maturityStage,
...
function generateOpportunityTable(results: B2bDiagnosticResults): string {
...
export function B2bSalesforceOutput({ results }: B2bSalesforceOutputProps) {
